-- ================================================================
-- Agentic RAG Engine — PostgreSQL + pgvector Schema
-- ================================================================
-- NOTE: The vector dimension MUST match your EMBEDDING_DIM setting.
--   - all-MiniLM-L6-v2  → 384
--   - text-embedding-3-small → 1536
-- Adjust the vector(...) declarations below accordingly.
-- ================================================================
...
CREATE TABLE IF NOT EXISTS chunks (
    ...
    content TEXT NOT NULL,
    embedding vector(384),    -- ← Match EMBEDDING_DIM
...
CREATE OR REPLACE FUNCTION match_chunks(
    query_embedding vector(384),  -- ← Match EMBEDDING_DIM
